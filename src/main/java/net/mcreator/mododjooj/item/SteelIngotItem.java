...
public class SteelIngotItem extends MododjoojModElements.ModElement {
	@ObjectHolder("mododjooj:steel_ingot")
	public static final Item block = null;
	public SteelIngotItem(MododjoojModElements instance) {
		super(instance, 48);
	}
